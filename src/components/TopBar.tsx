export default function TopBar() {
    return <section className="flex flex-col md:flex-row justify-center md:justify-between items-center gap-8 md:gap-3 border-b border-dark-gray-3 py-6 text-md lg:text-xs text-dark-gray-5">
      ...
      <menu className="flex justify-between gap-20">
